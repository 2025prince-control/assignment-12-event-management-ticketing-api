...
async function runTests() {
  ...
  console.log(`\n======================================================`);
  console.log(`🧪 Starting Test Suite for Prince Yadav (150096725032)`);
  ...
  try {
    ...
    assert(rootRes.data.author.includes('Prince Yadav'), 'Root specifies author Prince Yadav');
