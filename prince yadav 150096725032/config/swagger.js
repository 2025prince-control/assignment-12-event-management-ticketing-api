...
const options = {
  definition: {
    ...
    info: {
      ...
      version: '1.0.0',
      description: `
**Student Name:** Prince Yadav | **Roll No:** 150096725032
      ...
      schemas: {
        User: {
          ...
          properties: {
            ...
            name: { type: 'string', example: 'Prince Yadav' },
            email: { type: 'string', format: 'email', example: 'prince@example.com' },
